! function() {
    ...
    e.add("code", function(e) {
        ...
        return (t = e).addCommand("mceCodeEditor", function() {			
            ...
            tooltip: "Source code",
            onAction: function() {
				contentTextSelected = t.selection.getContent({format : 'html'});
                return o(n)
            }
	...
	function focusContentSelected(){
		var textareas = document.getElementsByClassName("tox-textarea");
		var textareaValue = (textareas[0]) ? textareas[0].value : "";
